...
var Graph = function (_Component) {
  ...
  _createClass(Graph, [{
    ...
    value: function componentDidMount() {
      this.edges = new _standalone.DataSet();
      this.edges.add(this.props.graph.edges);
      this.nodes = new _standalone.DataSet();
    ...
    value: function updateGraph() {
      ...
      this.Network = new _standalone.Network(this.container.current, Object.assign({}, this.props.graph, {
        edges: this.edges,
        nodes: this.nodes
      }), options);
